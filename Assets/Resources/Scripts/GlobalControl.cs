...
public class GlobalControl : MonoBehaviour {
	...
	public void sendConnection(){
		...
		if(clientNickName != ""){
			netMgr.srvConn.Connect("165.22.169.0", 12000);  // DigitalOcean
			// netMgr.srvConn.Connect("game.huangyu-an.com", 12000);
			// netMgr.srvConn.Connect("47.103.31.102", 12000);  // Aliyun
			// netMgr.srvConn.Connect("www.huangyu-an.com", 12000);
			// netMgr.srvConn.Connect("101.132.169.242", 12000);
			// netMgr.srvConn.Connect("10.21.94.14", 12000);
			// netMgr.srvConn.Connect("127.0.0.1", 12000);
			// netMgr.srvConn.Connect("192.168.0.100", 12000);
			...
			GameObject uiRoot = GameObject.Find("UI Root");
			GameObject messageBox = Resources.Load("prefabs/UI/emptyWindow") as GameObject;
        	messageBox = NGUITools.AddChild(uiRoot, messageBox);
	...
	public void credits(){
		GameObject uiRoot = GameObject.Find("UI Root");
		GameObject messageBox = Resources.Load("prefabs/UI/Credits") as GameObject;
        messageBox = NGUITools.AddChild(uiRoot, messageBox);
	}
